[myawesometmlsolutionml-2344] Operating Details
====================================

Generated On: 2024-10-14 01:30:24 UTC
...
.. important::
   ...
   **not be valid if your [myawesometmlsolutionml-2344] container is NOT running**.

.. tip::
   You must have your [myawesometmlsolutionml-2344] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=37261  \-\-env VIPERVIZPORT=48399  \-\-env GITUSERNAME='smaurice101'  \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:48399/iot-failure-machinelearning.html?topic=iot-preprocess,iot-ml-prediction-results-output&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:48399/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   maadsdocker/myawesometmlsolutionml-2344-amd64 (https://hub.docker.com/r/maadsdocker/myawesometmlsolutionml-2344-amd64)
...
.. important::
   docker run -d -p 57823:57823 -p 39663:39663 -p 42873:42873 \-\-env TSS=0 \-\-env SOLUTIONNAME=myawesometmlsolutionml-2344 \-\-env SOLUTIONDAG=solution_preprocessing_ml_dag-myawesometmlsolutionml-2344 \-\-env GITUSERNAME=smaurice101  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git \-\-env SOLUTIONEXTERNALPORT=57823  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=39663  \-\-env SOLUTIONVIPERVIZPORT=42873 \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env EXTERNALPORT=37261 \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env VIPERVIZPORT=48399 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  maadsdocker/myawesometmlsolutionml-2344-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=42873
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=57823
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - maadsdocker/myawesometmlsolutionml-2344-amd64
...
It can be accessed by entering: http://localhost:39663
...
.. important::
   http://localhost:42873/iot-failure-machinelearning.html?topic=iot-preprocess,iot-ml-prediction-results-output&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:42873/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:42873/<html file>
...
[myawesometmlsolutionml-2344] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/myawesometmlsolutionml-2344
...
.. important::
   https://myawesometmlsolutionml-2344.readthedocs.io
...
.. important::
   solution_preprocessing_ml_dag-myawesometmlsolutionml-2344
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=57823, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=45017, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=45273, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=46835, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=46269, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=33995, HPDEHOST=127.0.1.1, HPDEPORT=43183, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=42795

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-2404-myawesometmlsolutionml-2344,solution_preprocessing_ml_dag-myawesometmlsolutionml-2344, python-preprocess-6875-myawesometmlsolutionml-2344,solution_preprocessing_ml_dag-myawesometmlsolutionml-2344, python-ml-400-myawesometmlsolutionml-2344,solution_preprocessing_ml_dag-myawesometmlsolutionml-2344, python-predict-9304-myawesometmlsolutionml-2344,solution_preprocessing_ml_dag-myawesometmlsolutionml-2344, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
